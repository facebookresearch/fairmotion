"""
Quaternions class from https://github.com/sreyafrancis/PFNN/tree/master/motion
Holden, Daniel, Taku Komura, and Jun Saito. "Phase-functioned neural networks for character control." ACM Transactions on Graphics (TOG)
"""
