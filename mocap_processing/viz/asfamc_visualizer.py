...
def main(args):
    ...
    motions = [asfamc.load(file="tests/data/11.asf", motion='tests/data/11_01.amc')]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--asf-files", type=str, nargs="+", required=True)
    parser.add_argument("--amc-files", type=str, nargs="+", required=True)
